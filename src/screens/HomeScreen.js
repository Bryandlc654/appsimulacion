...
const HomeScreen = () => {
    ...
    const buttons = [
        ...
        { id: '2', label: 'Buscador de Preguntas', icon: require('../../assets/buscador_preguntas.png') },
        { id: '3', label: 'Simulador de Examen', icon: require('../../assets/simulador_examen.png') },
        { id: '4', label: 'Historial de Pruebas', icon: require('../../assets/historial_pruebas.png') },
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <TouchableOpacity onPress={toggleDropdown}>
                    <Image source={require('../../assets/user_photo.png')} style={styles.userPhoto} />
                </TouchableOpacity>
                {dropdownVisible && (
